...
export const webFetchTool: ChatCompletionTool = {
  ...
  function: {
    name: 'web_fetch',
    description:
      'Читает и извлекает основной текст веб-страницы по URL. Используй, когда нужен полный текст статьи/документации/новости по ссылке — от пользователя или из результатов web_search.',
    parameters: {
      type: 'object',
      properties: {
