...
├── e2e/      # Playwright — e2e-тесты, свой package.json, запуск: npm test
...
другие сервисы на нём) ведётся в соседнем проекте `server-management`, который лежит (скорее
всего) в `~/Projects/MyOwn/`.
