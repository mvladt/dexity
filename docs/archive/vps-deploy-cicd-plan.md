...
Статус: **завершено 2026-07-02**. Этот файл — источник правды по контексту и прогрессу
(сохранён в `docs/archive/`, см. `vps-deploy-cicd-result.md` для краткого итога).
...
### Этап 4 — Документация и чистка — ✅ выполнено 2026-07-02

- [x] Обновить `deploy/README.md` под новый процесс (CI/CD вместо ручного)
- [x] Обновить раздел «Деплой» в `server/specs/backend.md`
- [x] Добавить Dexity в таблицу приложений `~/Projects/MyOwn/server-management/CLAUDE.md` (др. репо)
- [x] Снять пункт CI/CD в корневом `TODO.md`
- [x] Перенести этот план + result в `docs/archive/`
