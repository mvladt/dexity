...
Последнее обновление: 2026-05-07 18:42
...
Спецификация прошла ревью и готова к реализации: `docs/dexity-spec.md`.

## Следующий шаг

Начать реализацию по §16 спеки — стартовать с `shared/types.ts`, затем бэкенд (`server/`).
